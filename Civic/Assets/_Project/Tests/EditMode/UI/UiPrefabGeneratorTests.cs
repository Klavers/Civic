...
namespace Civic.UI.Tests
{
    public sealed class UiPrefabGeneratorTests
    {
        ...
        public void GenerateAssetsAt_CreatesValidBaseAndVariants()
        {
            ...
            Assert.That(view.ResourceDetailRows.Count, Is.EqualTo(8));
            Assert.That(view.ResourceSummaryLabels.Count, Is.EqualTo(8));
            Assert.That(view.ResourceProducerBoxes.Count, Is.EqualTo(32));
            Assert.That(view.ResourceProducerLabels.Count, Is.EqualTo(32));
            Assert.That(view.ResourceProducerTooltips.Count, Is.EqualTo(32));
            Assert.That(view.BuildingActionRows.Count, Is.EqualTo(8));
            Assert.That(view.BuildingActionInfoLabels.Count, Is.EqualTo(8));
            Assert.That(view.BuildingCountLabels.Count, Is.EqualTo(8));
            Assert.That(view.BuildingCostLabels.Count, Is.EqualTo(8));
            Assert.That(view.BuildingInputOutputLabels.Count, Is.EqualTo(8));
            Assert.That(view.BuildingInputOutputTooltips.Count, Is.EqualTo(8));
            Assert.That(view.BuildingGdpDeltaLabels.Count, Is.EqualTo(8));
            Assert.That(view.BuildingActionButtons.Count, Is.EqualTo(8));
            Assert.That(view.BuildingButtonTooltips.Count, Is.EqualTo(8));
            Assert.That(view.TechnologyActionRows.Count, Is.EqualTo(8));
            Assert.That(view.TechnologyActionInfoLabels.Count, Is.EqualTo(8));
            Assert.That(view.TechnologyActionButtons.Count, Is.EqualTo(8));
        ...
        public void RegenerateBase_PreservesUserVariantOverride()
        {
            ...
            Assert.That(CountChildrenNamed(hudBase, "ResourceDetailRow08"), Is.EqualTo(1));
            Assert.That(CountChildrenNamed(hudBase, "ResourceProducerBox01"), Is.EqualTo(8));
            ...
            Assert.That(CountChildrenNamed(hudBase, "BuildingActionRow08"), Is.EqualTo(1));
            Assert.That(CountChildrenNamed(hudBase, "BuildingNameLabel"), Is.EqualTo(8));
            Assert.That(CountChildrenNamed(hudBase, "BuildingInputOutputCell"), Is.EqualTo(8));
            Assert.That(CountChildrenNamed(hudBase, "BuildingBuildButton01"), Is.EqualTo(1));
            Assert.That(CountChildrenNamed(hudBase, "BuildingBuildButton08"), Is.EqualTo(1));
            Assert.That(CountChildrenNamed(hudBase, "TechnologyActionRow01"), Is.EqualTo(1));
            Assert.That(CountChildrenNamed(hudBase, "TechnologyActionRow08"), Is.EqualTo(1));
            Assert.That(CountChildrenNamed(hudBase, "TechnologyInfoLabel"), Is.EqualTo(8));
            Assert.That(CountChildrenNamed(hudBase, "TechnologyResearchButton01"), Is.EqualTo(1));
            Assert.That(CountChildrenNamed(hudBase, "TechnologyResearchButton08"), Is.EqualTo(1));
